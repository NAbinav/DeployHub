...
CategoryFrameworksFrontendNext.js, React.js, ViteBackendFastAPI, Flask, Express, Node.jsGoNative Go applicationsStaticHTML, CSS, JavaScriptContainersCustom Dockerfile
...
Connect your GitHub repository via the DeployHub dashboard
Detect — DeployHub scans your repo to identify the framework
Build — Creates a framework-specific Docker image
Push — Uploads the image to GCP Artifact Registry
Deploy — Launches the container on Google Cloud Run
...
Infrastructure
ComponentTechnologyLanguageGo (Golang)Build SystemDockerRegistryGoogle Artifact RegistryRuntimeGoogle Cloud RunSource ControlGitHub
